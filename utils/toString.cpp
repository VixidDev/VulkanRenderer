...
#			undef CASE_
		...
		// Handle other values gracefully.
		std::ostringstream oss;
		oss << "VkPhysicalDeviceType(" << std::underlying_type_t<VkPhysicalDeviceType>(deviceType) << ")";
		return oss.str();
	}
...
#			undef CASE_
		...
		// Handle other values gracefully.
		std::ostringstream oss;
		oss << "VkDebugUtilsMessageSeverityFlagBitsEXT(" << std::underlying_type_t<VkDebugUtilsMessageSeverityFlagBitsEXT>(severity) << ")";
		return oss.str();
	}
