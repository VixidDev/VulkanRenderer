...
// This is near identical to LightShaderStorageBuffer, I could probably just use a general shader storage
...
void LightMatricesShaderStorageBuffer::update(VkCommandBuffer cmdBuff) {
