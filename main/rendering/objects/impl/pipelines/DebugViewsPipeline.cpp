#include "DebugViewsPipeline.hpp"
...
DebugViewsPipeline::DebugViewsPipeline(
	VulkanWindow* window,
...
void DebugViewsPipeline::recreate() {
	...
	vk::ShaderModule frag = loadShaderModule(*this->window->getDevice(), "assets/main/shaders/debug.frag.spv");
