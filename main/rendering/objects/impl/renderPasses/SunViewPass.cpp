...
SunViewPass::SunViewPass(VulkanWindow* window, VkSampleCountFlagBits* sampleCount) : RenderPass(window) {
	this->sampleCount = sampleCount;

	this->recreate();
}

void SunViewPass::recreate() {
	...
	subpasses[0].pColorAttachments = &subpassAttachment;
