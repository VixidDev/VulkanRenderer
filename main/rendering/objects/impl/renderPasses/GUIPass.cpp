...
void GUIPass::recreate() {
	...
	attachments[0].format = this->window->getSwapchain()->getFormat();
	...
	deps[0].dstAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT | VK_ACCESS_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_SHADER_READ_BIT;
