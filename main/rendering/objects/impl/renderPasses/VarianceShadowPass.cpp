#include "VarianceShadowPass.hpp"
...
VarianceShadowPass::VarianceShadowPass(VulkanWindow* window, VkSampleCountFlagBits* sampleCount) : RenderPass(window) {
	this->sampleCount = sampleCount;

	this->recreate();
}

void VarianceShadowPass::recreate() {
	...
	// This depth buffer is purely for depth testing during the shadow pass
	// it is not the buffer used to sample from for shadows
