...
void ForwardPipelineLayout::recreate() {
	...
	forwardLayouts.emplace_back(this->descriptorLayouts->at("image6F").handle); // Material textures
	...
	forwardShadowLayouts.emplace_back(this->descriptorLayouts->at("image3F").handle); // Shadows
	...
	forwardShadowLayouts.emplace_back(this->descriptorLayouts->at("image6F").handle); // Material textures
