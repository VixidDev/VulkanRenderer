#include "ArrayDepthTextureBuffer.hpp"
...
ArrayDepthTextureBuffer::ArrayDepthTextureBuffer(
...
void ArrayDepthTextureBuffer::recreate() {
	// Create VkImage
	...
	// Create the image view info initially with 2D_ARRAY view type and arraySize layerCount for the sampler2DArray descriptor
	VkImageViewCreateInfo viewInfo = {
		...
		.subresourceRange = VkImageSubresourceRange{ VK_IMAGE_ASPECT_DEPTH_BIT, 0, 1, 0, this->arraySize }
	};
...
vk::ImageView& ArrayDepthTextureBuffer::getImageView() {
